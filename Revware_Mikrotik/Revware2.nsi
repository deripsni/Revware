...
Section "MainSection" SEC01
  ...
  SetOutPath "$INSTDIR\build\gui"
  File "MikrotikManager\build\gui\base_library.zip"
  File "MikrotikManager\build\gui\gui.exe"
  CreateDirectory "$SMPROGRAMS\Revware "
  CreateShortCut "$SMPROGRAMS\Revware \Revware .lnk" "$INSTDIR\build\gui\gui.exe"
  CreateShortCut "$DESKTOP\Revware .lnk" "$INSTDIR\build\gui\gui.exe"
  File "MikrotikManager\build\gui\gui.exe.manifest"
  File "MikrotikManager\build\gui\out00-Analysis.toc"
  File "MikrotikManager\build\gui\out00-COLLECT.toc"
  File "MikrotikManager\build\gui\out00-EXE.toc"
  File "MikrotikManager\build\gui\out00-PKG.pkg"
  File "MikrotikManager\build\gui\out00-PKG.toc"
  File "MikrotikManager\build\gui\out00-PYZ.pyz"
  File "MikrotikManager\build\gui\out00-PYZ.toc"
  File "MikrotikManager\build\gui\warngui.txt"
  File "MikrotikManager\build\gui\xref-gui.html"
  SetOutPath "$INSTDIR"
  ...
  File "MikrotikManager\dist\gui\batch.log"
...
Section -Post
  ...
  WriteRegStr HKLM "${PRODUCT_DIR_REGKEY}" "" "$INSTDIR\build\gui\gui.exe"
  WriteRegStr ${PRODUCT_UNINST_ROOT_KEY} "${PRODUCT_UNINST_KEY}" "DisplayName" "$(^Name)"
  WriteRegStr ${PRODUCT_UNINST_ROOT_KEY} "${PRODUCT_UNINST_KEY}" "UninstallString" "$INSTDIR\uninst.exe"
  WriteRegStr ${PRODUCT_UNINST_ROOT_KEY} "${PRODUCT_UNINST_KEY}" "DisplayIcon" "$INSTDIR\build\gui\gui.exe"
...
Section Uninstall
  ...
  Delete "$INSTDIR\dist\gui\batch.log"
  Delete "$INSTDIR\dist\gui\base_library.zip"
  Delete "$INSTDIR\DarkOrange.qss"
  Delete "$INSTDIR\Coffee.qss"
  Delete "$INSTDIR\build\gui\xref-gui.html"
  Delete "$INSTDIR\build\gui\warngui.txt"
  Delete "$INSTDIR\build\gui\out00-PYZ.toc"
  Delete "$INSTDIR\build\gui\out00-PYZ.pyz"
  Delete "$INSTDIR\build\gui\out00-PKG.toc"
  Delete "$INSTDIR\build\gui\out00-PKG.pkg"
  Delete "$INSTDIR\build\gui\out00-EXE.toc"
  Delete "$INSTDIR\build\gui\out00-COLLECT.toc"
  Delete "$INSTDIR\build\gui\out00-Analysis.toc"
  Delete "$INSTDIR\build\gui\gui.exe.manifest"
  Delete "$INSTDIR\build\gui\gui.exe"
  Delete "$INSTDIR\build\gui\base_library.zip"
