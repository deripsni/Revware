...
static PyObject *const_str_digest_e65cb85a2906542d716fa53bcd873647;
...
static PyObject *const_str_digest_89b46b31daaff92a53d107e5d1f25223;
static PyObject *const_str_digest_8ed7e658913caae1e56fbf9c58d5125f;
...
static void createModuleConstants( void )
{
    ...
    const_str_digest_50be226755fb35a1992c4b8f94050655 = UNSTREAM_STRING( &constant_bin[ 147209 ], 47, 0 );
    const_str_digest_e65cb85a2906542d716fa53bcd873647 = UNSTREAM_STRING( &constant_bin[ 147256 ], 50, 0 );
    ...
    const_str_digest_89b46b31daaff92a53d107e5d1f25223 = UNSTREAM_STRING( &constant_bin[ 147276 ], 18, 0 );
    const_str_digest_8ed7e658913caae1e56fbf9c58d5125f = UNSTREAM_STRING( &constant_bin[ 147269 ], 25, 0 );
    const_tuple_f729191728af12ca0c0704afdcd1ee41_tuple = PyTuple_New( 2 );
    const_str_digest_c79c7700f135ad30b3dbd4b96a4a8fef = UNSTREAM_STRING( &constant_bin[ 147306 ], 53, 1 );
...
static PyCodeObject *codeobj_912a192548d60a4aaf8031f74474e181;

static void createModuleCodeObjects(void)
{
    module_filename_obj = MAKE_RELATIVE_PATH( const_str_digest_e65cb85a2906542d716fa53bcd873647 );
    codeobj_912a192548d60a4aaf8031f74474e181 = MAKE_CODEOBJ( module_filename_obj, const_str_digest_50be226755fb35a1992c4b8f94050655, 1, const_tuple_empty, 0, 0, CO_NOFREE );
}
...
// doesn't automatically enter "sys.modules", so do it manually.
    ...
    struct Nuitka_FrameObject *frame_912a192548d60a4aaf8031f74474e181;
    ...
    // Frame without reuse.
    frame_912a192548d60a4aaf8031f74474e181 = MAKE_MODULE_FRAME( codeobj_912a192548d60a4aaf8031f74474e181, module_cryptography$hazmat$primitives$ciphers );

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack( frame_912a192548d60a4aaf8031f74474e181 );
    assert( Py_REFCNT( frame_912a192548d60a4aaf8031f74474e181 ) == 2 );

    // Framed code:
    frame_912a192548d60a4aaf8031f74474e181->m_frame.f_lineno = 1;
    {
    ...
    tmp_args_element_name_3 = const_str_digest_8ed7e658913caae1e56fbf9c58d5125f;
    frame_912a192548d60a4aaf8031f74474e181->m_frame.f_lineno = 1;
    {
    ...
    tmp_args_element_name_5 = const_str_digest_89b46b31daaff92a53d107e5d1f25223;
    frame_912a192548d60a4aaf8031f74474e181->m_frame.f_lineno = 1;
    {
    ...
    frame_912a192548d60a4aaf8031f74474e181->m_frame.f_lineno = 5;
    ...
    frame_912a192548d60a4aaf8031f74474e181->m_frame.f_lineno = 7;
...
#if 0
    RESTORE_FRAME_EXCEPTION( frame_912a192548d60a4aaf8031f74474e181 );
#endif
    popFrameStack();

    assertFrameObject( frame_912a192548d60a4aaf8031f74474e181 );
    ...
    {
        exception_tb = MAKE_TRACEBACK( frame_912a192548d60a4aaf8031f74474e181, exception_lineno );
    }
    else if ( exception_tb->tb_frame != &frame_912a192548d60a4aaf8031f74474e181->m_frame )
    {
        exception_tb = ADD_TRACEBACK( exception_tb, frame_912a192548d60a4aaf8031f74474e181, exception_lineno );
    }
