...
static PyObject *const_list_str_digest_b4370755ec52000c567b3239bec529df_list;
extern PyObject *const_str_digest_14ef95124e44c60f7f171703f1a5fe7a;
static PyObject *const_str_digest_ad51939cde54fbe021616457a1ff7543;
static PyObject *const_str_digest_b4370755ec52000c567b3239bec529df;
...
static void createModuleConstants( void )
{
    ...
    const_str_digest_50be226755fb35a1992c4b8f94050655 = UNSTREAM_STRING( &constant_bin[ 151653 ], 47, 0 );
    const_list_str_digest_b4370755ec52000c567b3239bec529df_list = PyList_New( 1 );
    const_str_digest_b4370755ec52000c567b3239bec529df = UNSTREAM_STRING( &constant_bin[ 151700 ], 110, 0 );
    PyList_SET_ITEM( const_list_str_digest_b4370755ec52000c567b3239bec529df_list, 0, const_str_digest_b4370755ec52000c567b3239bec529df ); Py_INCREF( const_str_digest_b4370755ec52000c567b3239bec529df );
    const_str_digest_ad51939cde54fbe021616457a1ff7543 = UNSTREAM_STRING( &constant_bin[ 151810 ], 122, 0 );
...
static PyCodeObject *codeobj_23765011d62fe430c2581f31f29ded14;

static void createModuleCodeObjects(void)
{
    module_filename_obj = const_str_digest_ad51939cde54fbe021616457a1ff7543;
    codeobj_23765011d62fe430c2581f31f29ded14 = MAKE_CODEOBJ( module_filename_obj, const_str_digest_50be226755fb35a1992c4b8f94050655, 1, const_tuple_empty, 0, 0, CO_NOFREE );
}
...
// doesn't automatically enter "sys.modules", so do it manually.
    ...
    struct Nuitka_FrameObject *frame_23765011d62fe430c2581f31f29ded14;
    ...
    tmp_assign_source_2 = const_str_digest_ad51939cde54fbe021616457a1ff7543;
    ...
    tmp_assign_source_3 = LIST_COPY( const_list_str_digest_b4370755ec52000c567b3239bec529df_list );
    ...
    // Frame without reuse.
    frame_23765011d62fe430c2581f31f29ded14 = MAKE_MODULE_FRAME( codeobj_23765011d62fe430c2581f31f29ded14, module_cryptography$hazmat$primitives$ciphers );

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack( frame_23765011d62fe430c2581f31f29ded14 );
    assert( Py_REFCNT( frame_23765011d62fe430c2581f31f29ded14 ) == 2 );
    ...
    frame_23765011d62fe430c2581f31f29ded14->m_frame.f_lineno = 7;
...
#if 0
    RESTORE_FRAME_EXCEPTION( frame_23765011d62fe430c2581f31f29ded14 );
#endif
    popFrameStack();

    assertFrameObject( frame_23765011d62fe430c2581f31f29ded14 );
    ...
    {
        exception_tb = MAKE_TRACEBACK( frame_23765011d62fe430c2581f31f29ded14, exception_lineno );
    }
    else if ( exception_tb->tb_frame != &frame_23765011d62fe430c2581f31f29ded14->m_frame )
    {
        exception_tb = ADD_TRACEBACK( exception_tb, frame_23765011d62fe430c2581f31f29ded14, exception_lineno );
    }
